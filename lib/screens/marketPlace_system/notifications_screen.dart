        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              padding: const EdgeInsets.fromLTRB(15, 60, 20, 40),
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: Icon(
            isChat ? Icons.chat_bubble_outline : Icons.sell_outlined,
            color: isChat ? Colors.blue : Colors.red,
            size: 20,
          ),
        ),
        title: Text(
        ...
        onTap: () {
          if (isChat) {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (c) => NegotiationChat(docId: data['itemId']),
              ),
            );
          }
        },
