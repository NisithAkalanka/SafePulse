                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          width: double.infinity,
                          padding: EdgeInsets.fromLTRB(20, topPadding + 85, 20, 35),
                          decoration: const BoxDecoration(
                            gradient: LinearGradient(
                              colors: [gRedStart, gRedMid, gDarkEnd],
                              begin: Alignment.topCenter,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 20),
                                  _buildInternalPhotoUploader(inputBoxColor, textPrimary),
                                  ...
                                  _buildDrop(
                                    ...
                                    const ["Tech", "Stationary", "Fashion", "Books", "Other"],
                                    _selectedCategory,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 48), // Balancing space for the center title
                      ],
>>>>>>> Stashed changes
                    ),
                  ),
          ...
          child: Container(
            ...
            child: _selectedImages.isEmpty
                ? Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: const [
                      Icon(Icons.add_a_photo_outlined, color: gRedMid, size: 40),
                      SizedBox(height: 12),
                      Text("Tap to upload photo", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      Text("Up to 3 photos", style: TextStyle(color: Colors.grey, fontSize: 12)),
                    ],
                  )
                : Stack(
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(25),
                        child: Image.file(_selectedImages.first, width: double.infinity, height: 180, fit: BoxFit.cover),
                      ),
                      if (_selectedImages.length > 1)
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text("+${_selectedImages.length - 1} more", style: const TextStyle(color: Colors.white, fontSize: 12)),
                          ),
                        ),
                      Positioned(
                        top: 10,
                        ...
                        child: GestureDetector(
                          ...
                          child: const CircleAvatar(radius: 14, backgroundColor: Colors.white70, child: Icon(Icons.refresh, color: Colors.black, size: 18)),
                        ),
                      )
                    ],
                  ),
...
=======
  Widget _buildDrop(String label, IconData i, List<String> items, String? val, Function(String?) onChanged, Color cb, {String? Function(String?)? validator}) {
    return Container(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: items.map((e) => DropdownMenuItem<String>(value: e, child: Text(e, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600)))).toList(),
        onChanged: onChanged,
        dropdownColor: cb,
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Wrap(
        children: [
          ...
          ListTile(leading: const Icon(Icons.photo_camera), title: const Text("Take a Photo"), onTap: () { Navigator.pop(ctx); _pickImage(ImageSource.camera); }),
        ],
      ),
    );
  }
